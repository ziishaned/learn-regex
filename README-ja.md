...
- [基本的な Matcher](#1-basic-matchers)
- [メタ文字](#2-meta-characters)
  - [ピリオド](#21-full-stop)
  - [文字集合](#22-character-set)
    - [否定文字集合](#221-negated-character-set)
  - [繰り返し](#23-repetitions)
    - [アスタリスク](#231-the-star)
    - [プラス記号](#232-the-plus)
    - [疑問符](#233-the-question-mark)
  - [括弧](#24-braces)
  - [文字グループ](#25-character-group)
  - [選言](#26-alternation)
  - [特殊文字をエスケープする](#27-escaping-special-character)
  - [アンカー](#28-anchors)
    - [キャレット](#281-caret)
    - [ドル記号](#282-dollar)
- [文字集合の短縮表記](#3-shorthand-character-sets)
- [前後参照](#4-lookaround)
  - [肯定的な先読み](#41-positive-lookahead)
  - [否定的な先読み](#42-negative-lookahead)
  - [肯定的な後読み](#43-positive-lookbehind)
  - [否定的な後読み](#44-negative-lookbehind)
- [フラグ](#5-flags)
  - [大文字・小文字を区別しない](#51-case-insensitive)
  - [グローバル検索](#52-global-search)
  - [複数行](#53-multiline)
- [おまけ](#bonus)
