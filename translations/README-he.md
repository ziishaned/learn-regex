...
|*|תואם 0 או יותר חזרות של הסמל הקודם.|
|+|תואם חזרה אחת או יותר של הסמל הקודם.|
|?|הופך את הסמל הקודם לאופציונלי.|
|{n,m}|סוגריים מסולסלים. תואם לפחות חזרות "n" אך לא יותר מ- "m" של הסמל הקודם.|
